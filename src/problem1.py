...
def run_test_problem1a():
    ...
    # Test 3:
    expected = -0.201  # This is APPROXIMATELY the correct answer.
    ...
    # Test 4:
    expected = -1.928  # This is APPROXIMATELY the correct answer.
